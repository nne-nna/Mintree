...
const SEED_USER_ID = "user_34Q9T3p1gu2QLcmfjpClk5rSYs7";
...
const geenerateRandomAmount = (category: typeof categories.$inferInsert) => {
...
const generateTransactionsForDay = (day: Date) => {
    ...
    for (let i = 0; i < numTransactions; i++) {
        ...
        const amount = geenerateRandomAmount(category);
